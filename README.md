...
* Березюк Ксения>:
  * telegram: [K.Berezuck](https://t.me/ksenia_berezuck)
...
### Установка и запуск
```shell
 git clone https://github.com/kberezuck/dm_api_test
 cd dm_api_tests
...
В ветке clients - фреймворк, из которого вынесены вспомогательные библиотеки.  
...
```
 ...
 │   │   └── check_user.py       # Файл содержит assert-ы для метода post_v1_account
 │   │   └── responce_checker.py # Файл содержит assert-ы для проверки статус кода
